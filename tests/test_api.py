...
class TestPlanetpositionsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PlanetpositionsAPIClient(self.api_key)

    @patch('apiverve_planetpositions.apiClient.requests.get')
